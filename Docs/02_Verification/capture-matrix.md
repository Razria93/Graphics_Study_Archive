...
| Part2_Chapter05-08 | 확보 | 후보 | 제외 | Chapter05 Step1·3과 Chapter06 Step1 console 예제는 capture를 제외한다. Chapter05 Step2 GLM·Step4 SimpleMath 대응 screenshot과 Chapter06 Step2 기본 perspective pipeline screenshot을 확보했다. 현재 단계는 정지 image로 설명 가능해 video를 제외한다 |
