...
| Part4 Ch14-20 | `Examples` project scaffold | 진행 중 | 성공 | 진행 중 | 미확인 | 보류 | 단일 project 구조 반영, `.clang-format` project reference 제거, Ex1401 Debug/Release 확인 |
...
| Part4 Ch14 | `Ex1402_Blur` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | compute shader separable blur, SRV/UAV ping-pong, command argument `1402` |
