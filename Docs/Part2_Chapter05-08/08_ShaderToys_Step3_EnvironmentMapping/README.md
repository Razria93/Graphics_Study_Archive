...
Visual Studio에서 Debug x64와 Release x64 build/run을 확인합니다. 확인 범위에는 skybox cubemap 표시, Zelda model load, object texture 표시, `Use Reflection`, `Use Texture`, `Wireframe`, `Draw Normals`, `m_viewRot` 조작을 포함합니다.
