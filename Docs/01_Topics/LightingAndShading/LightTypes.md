...
- 동일한 GPU pipeline에서 Directional·Point·Spot을 비교한 구현은 [Chapter06 Step6 Example](../../../Part2_Chapter05-08/06_GraphicsPipeline_Step6_Lighting/README.md)과 [상세 Demo](../../03_Demos/Part2_Chapter05-08/06_Lighting.md)로 위임한다.
