...
| `09_UserInteraction_Step2_MousePicking` | 성공 | 성공 | 완료 | 기본·hover red PNG와 readback 경로 확인 |
...
- Step3~6은 mouse capture를 사용해 drag 중 cursor가 client 밖으로 나간 뒤 release되는 상태를 복구한다.
