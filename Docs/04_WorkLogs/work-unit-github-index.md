...
| `WU-GraphicsLab-Architecture` | 기본 제외 | 기본 제외 | PR #41 (merged), PR #42 (전환기 closeout Draft) | [WU-GraphicsLab-Architecture](work-units/WU-GraphicsLab-Architecture.md) | PR #41이 finalization 전에 merge되어 PR #42에서 예외 closeout과 정책 교정을 함께 검수한다. |
