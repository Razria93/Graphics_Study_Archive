...
| Part2 Ch05-08 | `06_GraphicsPipeline_Step3_ModelViewProj` | 완료 | 빌드 성공 / 실행 미확인 | 진행 중 | 완료 | 보류 | Model/View/Projection matrix and constant buffer |
| Part2 Ch05-08 | `05_*` - `08_*` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | Step4 이후 후보 |
