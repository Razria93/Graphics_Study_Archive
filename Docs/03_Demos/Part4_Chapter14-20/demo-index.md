...
| Sprite fire particles | 없음 | `Ex1502_SpriteFireEffect` | GPU Simulation, Texturing | [Verification](../../02_Verification/Part4_Chapter14-20/verification-index.md) | local screenshot 후보 | 미게시 | 보류 | `flare0.dds` provenance 확인 전 public 대표 visual 승격 보류 |
...
- Chapter15 `Ex1501`과 10초 지연 `Ex1503` selected screenshot은 `Docs/_assets/captures`에 승격하고 상세 Demo와 local Demo Issue 후보에 연결했다. `Ex1502`는 `flare0.dds` provenance 확인 전 보류로 둔다.
