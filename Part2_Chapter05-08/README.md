...
- Build/run: `05_*`, `06_GraphicsPipeline_Step1`-`Step9`, `07_Modeling_Step1_DrawingWireFrames`-`Step3_Grid`, `07_Modeling_Step5_Sphere_*`, `07_Modeling_Step6_Subdivision`, `07_Modeling_Step7_FaceNormals` 사용자 Debug/Release 실행 확인 완료. `07_Modeling_Step8_SphereMapping_*`는 import 완료, 실행 미확인
- 현재 후보: `07_Modeling_Step8_SphereMapping_*` 실행 확인
- 캡처: 보류
...
| Build/run status | `07_Modeling_Step8_SphereMapping_*` import 완료, 실행 미확인 |
| Next action | `07_Modeling_Step8_SphereMapping_*` Debug/Release 실행 확인 |
...
| `07_Modeling_Step4_Cylinder` | archive 반영 완료, Debug/Release 실행 미확인 |
...
| `07_Modeling_Step8_SphereMapping_UserSolution` | archive 반영 완료, Debug/Release 실행 미확인 |
| `07_Modeling_Step8_SphereMapping_ReferenceSolution` | archive 반영 완료, Debug/Release 실행 미확인 |
