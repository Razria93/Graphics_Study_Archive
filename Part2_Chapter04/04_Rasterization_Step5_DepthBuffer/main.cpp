...
int main() {
    ...
    while (WM_QUIT != msg.message) {
        if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE)) {
            ...
            ImGui::SliderFloat("center1_z", &example->rasterization.center1.z,
                               -1.0f, 1.0f);
            ImGui::SliderFloat("center2_z", &example->rasterization.center2.z,
                               -1.0f, 1.0f);
            ImGui::SliderFloat("center3_z", &example->rasterization.center3.z,
                               -1.0f, 1.0f);
