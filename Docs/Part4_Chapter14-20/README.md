...
| Build/run | Ex1401-Ex1501 Debug/Release 확인 완료, Ex1502 확인 대기 |
...
| [`Ex1502_SpriteFireEffect`](Ex1502_SpriteFireEffect/README.md) | 반영 완료 | 미확인 | 검토 필요 | textured fire sprite particles, `flare0.dds`, command argument `1502` |
...
1. `Ex1502_SpriteFireEffect`를 command argument `1502`로 실행 확인합니다.
