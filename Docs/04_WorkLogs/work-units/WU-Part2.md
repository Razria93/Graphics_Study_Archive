...
| --- | --- |
| Work Unit | `WU-Part2` |
| 현재 마감 대상 | `Part2_Chapter05-08` GitHub 게시 완료와 Ready PR merge 준비 |
...
- [Chapter05–08 PR #20](https://github.com/Razria93/Graphics_Study_Archive/pull/20)을 Draft로 게시한 뒤 Ready for Review로 전환했다.
