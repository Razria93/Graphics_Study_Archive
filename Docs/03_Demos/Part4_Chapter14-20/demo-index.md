...
| Particle baseline | 없음 | `Ex1501_ParticleSystem` | GPU Simulation | [Verification](../../02_Verification/Part4_Chapter14-20/verification-index.md) | local screenshot 후보 | 미게시 | 후보 | Chapter15 Debug x64 smoke에서 particle stream 후보 확보. tracked 승격 여부는 Chapter15 단위 승인에서 판단 |
...
| SPH water particles | 없음 | `Ex1503_SphWater` | GPU Simulation | [Verification](../../02_Verification/Part4_Chapter14-20/verification-index.md) | local screenshot 후보 | 미게시 | 후보 | SPH particle cluster 후보 확보. simulation movement는 desktop video 후속 후보 |
...
- Chapter15 `Ex1501`~`Ex1503` local screenshot 후보는 `local/capture-run/Part4_Chapter15/debug-smoke-20260806`에 둔다. `Ex1501`과 `Ex1503`은 tracked 승격 후보, `Ex1502`는 `flare0.dds` provenance 확인 전 보류로 둔다.
