...
| Part3 Ch10-13 | `10_GeometryPipeline_Step5_Tessellation` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | primary raw 기준 반영, reference snapshot과 tessellation 핵심 파일 차이 있음, Release shader setting 보정 |
| Part3 Ch10-13 | `11_TexturingTechniques_Step1_Mipmaps`-`13_*` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | primary raw 기준 진행, `_2`는 reference-only 비교용 |
