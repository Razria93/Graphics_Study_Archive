...
| --- | --- | --- | --- |
| `Part1_Chapter01-02` | pilot 검증 완료 | 코드 폴더 README | `02_Bloom` README 이관과 Debug/Release x64 build/run 확인. capture/result 승격은 보류 |
...
| Demo | `Docs/03_Demos` | 대표 capture와 영상 capture/result 연결 |
