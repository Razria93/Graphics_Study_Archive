...
| Chapter14 buffer/indirect evidence | 없음 | `Ex1404_StructuredBuffer`, `Ex1405_ConsumeAppendBuffer`, `Ex1407_IndirectArguments` | Resource Synchronization | [Verification](../../02_Verification/Part4_Chapter14-20/verification-index.md) | local 후보 | 미게시 | 후보 | Chapter14 확장 set 후보. `Ex1404`는 fixed UI visual, `Ex1405`는 append count stdout, `Ex1407`은 indirect draw code evidence 우선 |
...
- tracked screenshot 승격 전 `HLAB_CAPTURE_UI=collapsed`, 안정된 window bounds, taskbar 노출, metadata를 확인한다.
