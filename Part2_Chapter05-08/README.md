...
- Build/run: Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath, Step4 Lights(SimpleMath) 성공
- 캡처: 보류
...
| Build/run status | Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath, Step4 Lights(SimpleMath) 성공 |
| Next action | `06_GraphicsPipeline_Step1_COM` raw 구조 확인 |
