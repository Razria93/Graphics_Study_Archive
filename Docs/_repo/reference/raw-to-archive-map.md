...
| `C:\ComputerGraphics\Part2_Chapter05-08` | `Part2_Chapter05-08` | D3D11 pipeline, modeling, shader toys 참고 | 진행 중 | `05_*`, `06_*`, `07_Modeling_Step1_DrawingWireFrames`, `07_Modeling_Step2_DrawingNormals` 실행 성공, `07_Modeling_Step3_Grid` import 완료/실행 미확인 |
