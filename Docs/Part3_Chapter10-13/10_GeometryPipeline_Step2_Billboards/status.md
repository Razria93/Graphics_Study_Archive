# Status: 10_GeometryPipeline_Step2_Billboards
...
Primary raw folder `C:\ComputerGraphics\Part3_Chapter10_13\10_GeometryPipeline_Step2_Billboards`를 기준으로 import했습니다.
...
- selected TreeBillboards texture assets required by `BillboardPoints.cpp`
...
- 다음 import 대상은 `10_GeometryPipeline_Step3_NormalLines`입니다.
