...
- Build/run: Step1, TriangleToCircle, Step2, Step3, Step4, Step5, Step6 성공 / Step7 빌드 성공, 실행 미확인 / 이후 미확인
- 캡처: 보류
...
| Next action | `04_Rasterization_Step7_BackfaceCulling` 실행 확인 |
...
| `04_Rasterization_Step7_BackfaceCulling` | archive 반영 완료, Debug/Release 빌드 확인 완료, 실행 미확인 |
