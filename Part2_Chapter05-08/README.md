...
- Build/run: Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath, Step4 Lights(SimpleMath), Pipeline Step1 COM, Pipeline Step2 InitializingD3D, Pipeline Step3 ModelViewProj, Pipeline Step4 Shaders, Pipeline Step5 Texturing 성공
- 캡처: 보류
...
| Next action | `06_GraphicsPipeline_Step5_Texturing_LightingSelf` 사용자 실행 확인 후 `06_GraphicsPipeline_Step6_Lighting` 진행 |
...
| `06_GraphicsPipeline_Step5_Texturing_LightingSelf` | archive 반영 완료, Debug/Release build 성공, 실행 미확인 |
