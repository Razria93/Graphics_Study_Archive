# Status: 09 UserInteraction Step2 MousePicking
...
| 항목 | 상태 | 메모 |
| --- | --- | --- |
| Raw source | 확인 | `C:\ComputerGraphics\Part3_Chapter09\09_UserInteraction_Step2_MousePicking` |
| Debug variant | 제외 | `09_UserInteraction_Step2_MousePicking_Debug`는 reference-only, `memo.txt` 포함 |
| Archive target | 반영 | `Part3_Chapter09/09_UserInteraction_Step2_MousePicking` |
...
| Selected assets | 완료 | Step1에서 포함한 skybox DDS 3개와 ground texture 1개 재사용 |
...
다음 import 대상은 `09_UserInteraction_Step3_MousePickingRayCollision`입니다.
