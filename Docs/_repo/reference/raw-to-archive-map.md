...
| `C:\ComputerGraphics\Part2_Chapter05-08` | `Part2_Chapter05-08` | D3D11 pipeline, modeling, shader toys 참고 | 진행 중 | Step1-Step4 실행 성공 / Pipeline Step1 COM, Step2 InitializingD3D, Step3 ModelViewProj, Step4 Shaders, Step5 Texturing, Step5 Texturing LightingSelf 실행 성공 / Step6 Lighting build 성공, run 미확인 |
