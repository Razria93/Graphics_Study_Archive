...
| `13_LightAndShadow_Step8_UnrealSphereLight` | primary | 반영 완료 | 미확인 | 검토 필요 | sphere light, primary raw `BasicPS.hlsl` representative point 구현본 반영, Release shader setting 보정 |
...
다음 작업은 `13_LightAndShadow_Step8_UnrealSphereLight` Debug/Release 실행 확인입니다.
