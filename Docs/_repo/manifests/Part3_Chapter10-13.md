...
- Build/run status: Step1-Step5, 11-Step1-Step5, 12-Step1-Step2, and 13-Step1 성공 / 13-Step2 PipelineStateObject 미확인
...
| `13_LightAndShadow_Step2_PipelineStateObject` | primary + origin character reference | 반영 완료 | 미확인 | 검토 필요 | pipeline state, character asset enabled |
...
`13_LightAndShadow_Step2_PipelineStateObject` Debug/Release 실행 확인 후 `13_LightAndShadow_Step2_Shadow` import를 진행합니다.
