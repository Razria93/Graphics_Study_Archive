...
namespace hlab
{
    ...
    public:
        ...
        std::shared_ptr<Object> vertexColorTriangle;
        ...
        {
            Hit closestHit = Hit{-1.0f, vec3(0.0f), vec3(0.0f), vec3(0.0f), nullptr};
        ...
        vec3 InterpolateVertexColor(const Hit &hit)
        {
            const vec3 color0(1.0f, 0.0f, 0.0f);
            const vec3 color1(0.0f, 1.0f, 0.0f);
            const vec3 color2(0.0f, 0.0f, 1.0f);
        ...
        vec3 traceRay(Ray &ray)
        {
            ...
            if (hit.obj == vertexColorTriangle)
            {
                pointColor = InterpolateVertexColor(hit);
            }
            ...
            return pointColor + hit.obj->dif * diffuse + hit.obj->spec * specular;
        }
