...
| `13_LightAndShadow_Step6_SoftShadowPCSS` | primary | 반영 완료 | 미확인 | 검토 필요 | PCSS soft shadow, primary raw PCSS 사용자 메모 포함 구현본 반영, Release shader setting 보정 |
...
`13_LightAndShadow_Step6_SoftShadowPCSS` Debug/Release 실행 확인 후 `13_LightAndShadow_Step7_Halo` import를 진행합니다.
