...
- 학습 코드 정리: Chapter05 Step1–4 bundle과 Chapter06 Step1–5 정규화 완료
- Build/run: Chapter05 Step1–4와 Chapter06 Step1–5 현재 재검증 완료, 나머지 예제 과거 확인 유지
...
| Import status | code import 완료 / Chapter05 Step1–4와 Chapter06 Step1–5 순차 verification 완료 |
| Public readiness | 검토 필요 |
| Build/run status | Chapter05 Step1–4와 Chapter06 Step1–5 Debug/Release x64 현재 확인, 나머지 과거 확인 |
| Next action | Chapter06 Step5 Texturing LightingSelf 순차 정규화 |
