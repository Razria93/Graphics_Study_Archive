...
| Build/run status | `08_ShaderToys_Step3_EnvironmentMapping`까지 실행 확인 완료 |
| Next action | `08_ShaderToys_Step4_ImageBasedLighting` Debug/Release 실행 확인 |
...
| `08_ShaderToys_Step4_ImageBasedLighting` | archive 반영 완료, Debug/Release 실행 미확인 |
