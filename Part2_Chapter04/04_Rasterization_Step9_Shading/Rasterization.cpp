...
Rasterization::Rasterization(const int &width, const int &height)
    ...
    light.lightAmbient = vec3(1.0f);
    light.lightDiffuse = vec3(1.0f);
    light.lightSpecular = vec3(1.0f);
    ...
    this->object->transformation.rotationY = 3.141592f * 45.0f / 180.0f;
    this->object->transformation.scale = vec3(1.0f);
    this->object->transformation.translation = vec3(0.0f, -0.36f, 1.0f);

    this->object->material.matAmbient = vec3(0.2f);
    this->object->material.matDiffuse = vec3(1.0f);
    this->object->material.matSpecular = vec3(1.0f);
    this->object->material.shininess = 10.0f;
    this->object->material.kd = 0.8f;
    this->object->material.ks = 0.8f;
