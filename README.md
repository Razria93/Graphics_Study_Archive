...
`Part1_Chapter01-02` pilot, `Part1_Chapter03`과 `Part2_Chapter04` 순차 정규화를 마감했다. `Part2_Chapter05-08`은 Chapter05 Step1–4와 Chapter06 Step1–5A를 정규화했고 다음 대상은 Step6 Lighting이다.
...
| `Part2_Chapter05-08` | DirectX11 pipeline, texture, mesh 흐름 | 완료 | Chapter05 Step1–4와 Chapter06 Step1–5A 문서화·재검증 완료 |
