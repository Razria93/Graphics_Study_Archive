...
- 현재 문서화: Step4~5 완료, Step6 문서화 대기
- 현재 재검증: Step4~5 Debug/Release x64 build/run 완료
- 과거 확인: Step6~14 Debug/Release build/run 성공, 현재 재검증 필요
- Capture: Step4~5 screenshot 확보
...
| Public readiness | Step4~5 검토 필요, Step6~14 미판정 |
| Build/run status | Step4~5 현재 확인, Step6~14 과거 확인 |
...
| Next action | Step6 PerspectiveView 검증과 문서화 |
...
Step6 이후 Topic은 해당 Step의 코드와 실행 결과를 확인한 뒤 순서대로 연결한다.
