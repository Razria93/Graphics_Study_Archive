...
| Part2_Chapter05-08 | Chapter05 Step2 Lights(GLM) | model, cubemap, IBL, bloom | Chapter05 Step1~4 affine bundle, shader toy variants | 후보 | Step2로 최소 Demo를 확보하고 Step2·4 visual을 GLM→DirectXMath/SimpleMath 전환 bundle 비교로 둔다. Chapter 대표는 후속 선정 |
