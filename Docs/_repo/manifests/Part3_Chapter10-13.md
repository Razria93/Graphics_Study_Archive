...
| `10_GeometryPipeline_Step4_Fireball` | primary | 반영 완료 | 미확인 | 검토 필요 | fireball shader, fireball texture 포함, Release shader setting 보정 |
...
사용자가 `10_GeometryPipeline_Step4_Fireball` Debug/Release 실행을 확인한 뒤 status/tracking 문서를 갱신합니다.
