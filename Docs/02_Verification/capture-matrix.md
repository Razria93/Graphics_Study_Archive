...
| Part2_Chapter05-08 | 확보 | 후보 | 제외 | Chapter05 Step1 console 예제는 제외한다. Step2 Lights(GLM)의 기본·non-uniform scale screenshot으로 Chapter 최소 visual을 확보하고, 정지 image 두 장으로 차이를 설명할 수 있어 video는 제외한다 |
