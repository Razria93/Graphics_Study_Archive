...
| Chapter03 순차 작업 | 진행 중 | Step4 DrawingSphere, Step5 PhongShading, Step6 PerspectiveView, Step7 Triangle, Step8 Shadow와 Step8 Shadow_Square build/run, README, Topic, Demo와 capture를 완료했다. |
