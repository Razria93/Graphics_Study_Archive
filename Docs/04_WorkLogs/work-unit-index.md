...
| [WU-GraphicsLab-Architecture](work-units/WU-GraphicsLab-Architecture.md) | Phase S reconstruction 전략, Phase A original evidence, WU-A0 architecture | Decision, Review, Architecture, Part1 roadmap | 진행 중 | PR #41 일반 merge와 PR #42 Draft 사용자 검수 완료, Ready for Review 대기 |
...
- Review 완료와 merge 승인 후 `마감` 전환을 finalization commit에 포함한다.
