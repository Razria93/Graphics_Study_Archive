# 13 Light and Shadow Step7 Halo Status
...
| --- | --- |
| Code import | 완료 |
| Raw basis | `C:\ComputerGraphics\Part3_Chapter10_13\13_LightAndShadow_Step7_Halo` |
...
- `PostEffectsPS.hlsl`는 origin/`_2`보다 길며, view-space reconstruction, ray-sphere intersection, halo emission, depth occlusion 관련 메모와 구현을 포함합니다.
