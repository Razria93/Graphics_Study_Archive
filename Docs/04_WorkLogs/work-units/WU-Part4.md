...
| GitHub | Chapter14 merged · Chapter15 PR 후보 작성 | Chapter14 Demo Issue #29, Progress Phase 5-1 완료 댓글과 PR #30을 게시·review 대응·merge까지 마감했다. Chapter15 Demo Issue #31, Progress 누적 댓글 갱신과 Phase 5-2 완료 댓글을 게시하고 PR body 후보를 작성했다. |
...
1. Chapter15 PR 생성은 별도 승인 후 진행한다.
