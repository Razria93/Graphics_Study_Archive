...
| `Ex1502_SpriteFireEffect` | `1502` | `Part4_Chapter14-20/Examples.sln` | 성공 | 성공 | 성공 | 성공 | tracked 후보 | 2026-08-06 Debug x64 build/run smoke와 sprite fire rendered screenshot 후보를 `Docs/_assets/captures`에 승격. 원본 `flare0.dds`는 직접 링크하지 않음. Release는 과거 확인 |
...
| `Ex1502_SpriteFireEffect` | Debug x64 | `1502` | 성공 | [tracked screenshot](../../_assets/captures/part4_chapter15_02_sprite_fire_effect.png) | sprite fire texture visual 확인. 원본 `Assets/Textures/flare0.dds`는 직접 링크하지 않고 rendered evidence만 사용 |
...
| `Ex1502_SpriteFireEffect` | `ex1502-sprite-fire-effect.png` | sprite fire visual과 fixed UI 기준 확인. PNG text metadata chunk 없음. `flare0.dds` runtime asset을 사용함 | tracked 승격 | [tracked screenshot](../../_assets/captures/part4_chapter15_02_sprite_fire_effect.png)을 rendered evidence로 사용하고 원본 `flare0.dds`는 직접 링크하지 않음 |
