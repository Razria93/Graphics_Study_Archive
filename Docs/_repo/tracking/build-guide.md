...
| Part2 | `Part2_Chapter05-08/06_GraphicsPipeline_Step7_ResizingViewport` | 성공 | 성공 | 미확인 | 보류 | viewport resizing, Release HLSL shader type 설정 보강 후 성공, asset public readiness 검토 필요 |
