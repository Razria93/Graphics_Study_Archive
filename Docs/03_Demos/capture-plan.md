...
- Step4 DrawingSphere와 Step5 PhongShading의 기본·파라미터 조정 screenshot, Step6 PerspectiveView부터 Step9 Barycentric Coordinates까지의 기본 screenshot을 동일한 전체 application window 규격으로 확보했다.
- Step10 Texturing은 local 전체 창 후보를 확보했지만 외부 입력 texture의 출처·라이선스 확인 전 승격을 보류한다.
