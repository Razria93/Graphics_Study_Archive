...
| `11_TexturingTechniques_Step2_NormalMapping` | primary | 반영 완료 | 미확인 | 검토 필요 | normal map/TBN 구현, PBR texture 8개 선별 포함 |
...
사용자가 `11_TexturingTechniques_Step2_NormalMapping` Debug/Release 실행을 확인하면 status/tracking 문서를 갱신합니다.
