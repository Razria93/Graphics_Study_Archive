...
- Build/run: Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath, Step4 Lights(SimpleMath), Pipeline Step1 COM, Pipeline Step2 InitializingD3D 성공 / Pipeline Step3 ModelViewProj 빌드 성공, 실행 미확인
- 캡처: 보류
...
| Next action | `06_GraphicsPipeline_Step3_ModelViewProj` Debug/Release 실행 확인 |
...
| `06_GraphicsPipeline_Step3_ModelViewProj` | archive 반영 완료, Debug/Release build 성공, 실행 미확인 |
