...
- 현재 확인: Chapter05 Step1 Matrix(GLM)·Step2 Lights(GLM)·Step3 DirectXMath·Step4 Lights(SimpleMath), 2026-08-02
- 과거 확인: 나머지 예제, 문서화 이전(날짜 미기록)
- 현재 재검증: Step1·2·3·4 완료, 나머지 필요
- 근거: Step1·2·3·4 Debug/Release x64 직접 실행과 Chapter README의 전체 예제 과거 성공 기록
