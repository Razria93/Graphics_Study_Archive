...
int main() {
    ...
    HWND hwnd = CreateWindow(
        wc.lpszClassName, L"ComputerGraphics - Chapter05 Step2 Lights(GLM)",
    ...
    while (WM_QUIT != msg.message) {
        if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE)) {
            ...
            ImGui::SliderFloat3(
                "Material specular",
                &example->rasterization.object->material.specular[0], 0.0f,
                1.0f);
            ImGui::SliderFloat(
                "Material shininess",
            ...
            ImGui::SliderFloat3("Light Position",
                                &example->rasterization.light.position[0],
                                -2.0f, 2.0f);
