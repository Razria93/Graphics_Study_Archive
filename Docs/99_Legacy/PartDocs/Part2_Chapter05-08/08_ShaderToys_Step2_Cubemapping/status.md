...
| Asset selection | 완료 | 실행 경로의 `skybox/skybox.dds`와 Zelda model/texture 선별 포함 |
...
- `local/Part2_Chapter05-08/08_ShaderToys_Step2_Cubemapping/source-comments.md`
- `local/Part2_Chapter05-08/08_ShaderToys_Step2_Cubemapping/study-review.local.md`
