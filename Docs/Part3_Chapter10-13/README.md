...
- Build/run: Step1-Step5 and 11-Step1-Step2 성공, 11-Step3 미확인
- Capture: 보류
...
| `11_TexturingTechniques_Step3_HeightMapping` | 반영 완료 | 미확인 | 검토 필요 | height texture 기반 vertex displacement, Step2 PBR texture 재사용 |
...
1. 사용자가 `11_TexturingTechniques_Step3_HeightMapping` Debug/Release 실행을 확인합니다.
2. 실행 확인 후 status 문서와 tracking board를 갱신합니다.
3. 다음 import 대상은 `11_TexturingTechniques_Step4_HDRI`입니다.
