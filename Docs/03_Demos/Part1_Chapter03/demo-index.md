...
| Step10 Texturing | 없음 | [Example README](../../../Part1_Chapter03/03_Raytracing_Step10_Texturing/README.md) | [Texture Sampling](../../01_Topics/TexturingAndMapping/TextureSampling.md), [Barycentric Coordinates](../../01_Topics/RayTracing/BarycentricCoordinates.md) | [현재 확인](../../02_Verification/Part1_Chapter03/verification-index.md) | 없음 | 미게시 | 보류 | Debug/Release x64와 local 전체 창 후보 확인. 외부 입력 texture 출처·라이선스 확인 전 상세 Demo와 capture 승격 보류 |
