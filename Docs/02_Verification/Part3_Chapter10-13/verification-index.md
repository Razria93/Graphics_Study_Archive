...
| `11_TexturingTechniques_Step4_HDRI` | `Part3_Chapter10-13/11_TexturingTechniques_Step4_HDRI/11_TexturingTechniques_Step4_HDRI.sln` | 성공 | 성공 | 성공 | 성공 | 미확인 | 과거 확인 · 현재 재검증 필요 |
| `11_TexturingTechniques_Step5_HDRPipeline` | `Part3_Chapter10-13/11_TexturingTechniques_Step5_HDRPipeline/11_TexturingTechniques_Step5_HDRPipeline.sln` | 성공 | 성공 | 성공 | 성공 | 미확인 | 과거 확인 · 현재 재검증 필요 |
