...
- Debug/Release 실행을 직접 확인하기 전까지 build/run은 `미확인`으로 기록합니다.
...
| [`04_Rasterization_Step6_ShadersConcept`](04_Rasterization_Step6_ShadersConcept/README.md) | 완료 | 빌드 성공 / 실행 미확인 | 진행 중 | 보류 | CPU-side shader stage concept |
