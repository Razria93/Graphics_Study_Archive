...
| `WU-Part4 / Chapter15` | `Docs/07_GitHub/plan/comments/phase-5-2-plan-comment.md` (`comment-ready`) | 기본 제외 | 없음 | `Docs/07_GitHub/issues/demo/demo_part4_chapter15.md` (`ready`) | 없음 | 예정 | [WU-Part4](work-units/WU-Part4.md) | Ex1501, Ex1502와 10초 지연 Ex1503 tracked capture를 Chapter15 Demo Issue body에 연결했다. Ex1502는 원본 `flare0.dds`를 직접 링크하지 않고 rendered evidence로만 다룬다. |
