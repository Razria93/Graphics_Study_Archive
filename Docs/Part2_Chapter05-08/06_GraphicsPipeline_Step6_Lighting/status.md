# Status: 06 GraphicsPipeline Step6 Lighting
...
- 주요 구현: Blinn-Phong lighting, directional/point/spot light, material/light constant buffer, texture toggle, `Common.hlsli`
...
- 다음 후보는 `07_Modeling_*` 또는 `06_GraphicsPipeline`의 남은 후보 확인입니다.
