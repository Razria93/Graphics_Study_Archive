...
- 학습 코드 정리: Chapter05 Step1~4 bundle과 Chapter06 Step1 COM 정규화 완료
- Build/run: Chapter05 Step1~4와 Chapter06 Step1 현재 재검증 완료, 나머지 예제 과거 확인 유지
- 현재 대상: Chapter06 graphics pipeline 순차 정규화
- 캡처: Chapter05 Step2·4 screenshot 확보, Chapter06 Step1 console 예제 제외
...
| Import status | code import 완료 / Chapter05 Step1~4와 Chapter06 Step1 순차 verification 완료 |
| Public readiness | 검토 필요 |
| Build/run status | Chapter05 Step1~4와 Chapter06 Step1 Debug/Release x64 현재 확인, 나머지 과거 확인 |
| Next action | Chapter06 Step2 InitializingD3D 순차 정규화 |
...
| `06_GraphicsPipeline_Step2_InitializingD3D` | 코드 보관 완료 및 현재 문서화 대기 |
| `06_GraphicsPipeline_Step3_ModelViewProj` | 코드 보관 완료 및 현재 문서화 대기 |
| `06_GraphicsPipeline_Step4_Shaders` | 코드 보관 완료 및 현재 문서화 대기 |
| `06_GraphicsPipeline_Step5_Texturing` | 코드 보관 완료 및 현재 문서화 대기 |
| `06_GraphicsPipeline_Step5_Texturing_LightingSelf` | 코드 보관 완료 및 현재 문서화 대기 |
