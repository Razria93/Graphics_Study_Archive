...
| Part3 Ch10-13 | `11_TexturingTechniques_Step5_HDRPipeline` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | HDR DDS replacement assets 반영, 사용자 Debug/Release 실행 확인 필요 |
| Part3 Ch10-13 | `12_*`-`13_*` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | primary raw 기준 진행, `_2`는 reference-only 비교용 |
