...
| 항목 | 위치 | 책임 |
| --- | --- | --- |
| demo 우선순위 | `Docs/04_Demos/demo-priority.md` | Part별 최소/대표/선택 demo 후보 |
| screenshot 계획 | `Docs/04_Demos/capture-plan.md` | screenshot evidence 확보 기준 |
| video 계획 | `Docs/04_Demos/video-plan.md` | video evidence 확보 기준 |
| Part별 demo index | `Docs/04_Demos/<Part*>/demo-index.md` | Part/Chapter별 demo 후보와 evidence 연결 |
...
| 공개 판단 | `Docs/06_Publication` | public 후보 여부와 제외 사유 |
