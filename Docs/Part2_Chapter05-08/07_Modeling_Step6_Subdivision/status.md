...
- `local/Part2_Chapter05-08/07_Modeling_Step6_Subdivision/source-comments.md`
- `local/Part2_Chapter05-08/07_Modeling_Step6_Subdivision/study-review.local.md`
...
- subdivision sphere 정상 표시: 확인 완료
