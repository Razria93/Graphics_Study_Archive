...
void ExampleApp::Update(float dt) {
    ...
    m_mainObj.m_basicVertexConstData.projection = projRow.Transpose();
...
void ExampleApp::UpdateGUI() {
    ...
    if (ImGui::TreeNode("Material")) {
        ...
        flag += ImGui::SliderFloat(
            "Metallic", &m_mainObj.m_basicPixelConstData.material.metallic,
            0.0f, 1.0f);
        flag += ImGui::SliderFloat(
            "Roughness", &m_mainObj.m_basicPixelConstData.material.roughness,
            0.0f, 1.0f);
        ...
        flag += ImGui::CheckboxFlags(
            "Use HeightMapping", &m_mainObj.m_basicVertexConstData.useHeightMap,
            1);
        flag += ImGui::SliderFloat(
