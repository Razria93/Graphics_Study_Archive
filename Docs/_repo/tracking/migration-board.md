...
| Part3 Ch10-13 | `11_TexturingTechniques_Step1_Mipmaps` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | primary raw 기준 반영, reference snapshot과 mipmap 핵심 파일 차이 있음, `captured.png` 제외, Release shader setting 보정 |
| Part3 Ch10-13 | `11_TexturingTechniques_Step2_NormalMapping`-`13_*` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | primary raw 기준 진행, `_2`는 reference-only 비교용 |
