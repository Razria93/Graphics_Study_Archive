...
| Particle baseline | 없음 | `Ex1501_ParticleSystem` | GPU Simulation | [Verification](../../02_Verification/Part4_Chapter14-20/verification-index.md) | [tracked capture](../../_assets/captures/part4_chapter15_01_particle_system.png) | 미게시 | 후보 | Chapter15 Debug x64 smoke에서 particle stream 후보를 승격. Chapter15 대표 set 포함 여부는 후속 Demo body에서 판단 |
...
| SPH water particles | 없음 | `Ex1503_SphWater` | GPU Simulation | [Verification](../../02_Verification/Part4_Chapter14-20/verification-index.md) | [tracked capture](../../_assets/captures/part4_chapter15_03_sph_water.png) | 미게시 | 후보 | 10초 지연 capture에서 SPH particles가 아래에 쌓인 selected 후보를 승격. simulation movement는 desktop video 후속 후보 |
...
- Chapter15 `Ex1501`과 10초 지연 `Ex1503` selected screenshot은 `Docs/_assets/captures`에 승격했다. `Ex1502`는 `flare0.dds` provenance 확인 전 보류로 둔다.
