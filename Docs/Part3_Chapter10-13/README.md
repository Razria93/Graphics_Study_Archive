...
- Build/run: Step1-Step5, 11-Step1-Step5, 12-Step1-Step2, 13-Step1, 13-Step2 PipelineStateObject, 13-Step2 Shadow, 13-Step3, 13-Step4, and 13-Step5 성공
- Capture: 보류
...
| `13_LightAndShadow_Step6_SoftShadowPCSS` | 반영 완료 | 미확인 | 검토 필요 | PCSS soft shadow, primary raw PCSS 사용자 메모 포함 구현본 반영, Release shader setting 보정 |
...
1. `13_LightAndShadow_Step6_SoftShadowPCSS` Debug/Release 실행 확인.
