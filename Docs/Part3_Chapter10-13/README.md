...
| `11_TexturingTechniques_Step1_Mipmaps` | 반영 완료 | 성공 | 검토 필요 | `SampleLevel` 기반 mipmap LOD, `captured.png` 제외, Release shader setting 보정 |
...
1. 다음 import 대상은 `11_TexturingTechniques_Step2_NormalMapping`입니다.
2. normal map texture dependency와 tangent-space 관련 shader 변경을 raw 기준으로 확인합니다.
