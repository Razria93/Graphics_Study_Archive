...
- 대응: validator multiline heading 검사와 legacy publication 링크를 수정했습니다.
- 검증: `validate-github-body.ps1`, `git diff --check`, 임시 `## Metadata` 회귀 케이스를 확인했습니다.
- 비고: 두 리뷰 코멘트 모두 같은 커밋에서 처리했습니다.
```
