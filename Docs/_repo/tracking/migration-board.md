...
| Part3 Ch10-13 | `13_LightAndShadow_Step1_Mirror` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | mirror/stencil, Sample HDRI DDS and UV grid texture reused, character asset enabled, 사용자 Debug/Release 실행 확인 필요 |
| Part3 Ch10-13 | `13_LightAndShadow_Step2_*`-`13_LightAndShadow_Step8_*` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | primary raw 기준 진행, `_2`는 reference-only 비교용 |
