...
- Build/run: Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath, Step4 Lights(SimpleMath) 성공 / Pipeline Step1 COM 빌드 성공, 실행 미확인
- 캡처: 보류
...
| Next action | `06_GraphicsPipeline_Step1_COM` Debug/Release 실행 확인 |
...
| `06_GraphicsPipeline_Step1_COM` | archive 반영 완료, Debug/Release build 성공, 실행 미확인 |
