...
| `13_LightAndShadow_Step7_Halo` | primary | 반영 완료 | 미확인 | 검토 필요 | halo post effect, primary raw `PostEffectsPS.hlsl` 구현본 반영, Release shader setting 보정 |
...
다음 작업은 `13_LightAndShadow_Step7_Halo` Debug/Release 실행 확인입니다.
