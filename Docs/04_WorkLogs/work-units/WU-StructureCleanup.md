...
- `Docs/00_Index`부터 `Docs/05_Publication`까지 산출물 기준 폴더를 만들고, 각 폴더의 `README.md`와 `AGENTS.md`를 두었다.
- `Docs/06_Policies`에 문서 작성, GitHub workflow, 검증, publication, 용어, 문체 정책을 모았다.
...
| Topic | `Docs/01_Topics` | 골격 생성 |
| Verification | `Docs/02_Verification` | 골격 생성 |
| Demo | `Docs/03_Demos` | 골격 생성 |
| WorkLog | `Docs/04_WorkLogs` | 골격 생성 |
| Publication | `Docs/05_Publication` | 골격 생성 |
| Policy | `Docs/06_Policies` | 정리 |
...
- pilot 진행 전 코드 폴더 README, `Docs/01_Topics`, `Docs/02_Verification`, `Docs/03_Demos`의 양식이 과하지 않은지 다시 확인한다.
