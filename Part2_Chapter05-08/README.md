...
- Build/run: Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath, Step4 Lights(SimpleMath), Pipeline Step1 COM 성공
- 캡처: 보류
...
| Next action | `06_GraphicsPipeline_Step2_InitializingD3D` raw 구조 확인 |
