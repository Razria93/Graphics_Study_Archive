...
| Part1 Ch03 | `03_Raytracing_Step4_DrawingSphere` | 완료 | 성공 | 진행 중 | 완료 | 보류 | 사용자가 Debug/Release 실행 정상 확인 |
| Part1 Ch03 | `03_Raytracing_Step5_PhongShading` | 완료 | 성공 | 진행 중 | 완료 | 보류 | 사용자가 Debug/Release 실행 정상 확인 |
| Part1 Ch03 | `03_Raytracing_Step6_PerspectiveView` | 완료 | 성공 | 진행 중 | 완료 | 보류 | 사용자가 Debug/Release 실행 정상 확인 |
| Part1 Ch03 | `03_Raytracing_Step7_Triangle` | 완료 | build 성공 / run 미확인 | 진행 중 | 완료 | 보류 | Debug/Release x64 build 성공 |
| Part1 Ch03 | `Step8-9, Step11` | 예정 | 미확인 | 미확인 | 미확인 | 보류 | 2차 후보 |
