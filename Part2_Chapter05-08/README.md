...
- 학습 코드 정리: Chapter05 Step1–4 bundle과 Chapter06 Step1–3 정규화 완료
- Build/run: Chapter05 Step1–4와 Chapter06 Step1–3 현재 재검증 완료, 나머지 예제 과거 확인 유지
- 현재 대상: Chapter06 graphics pipeline 순차 정규화
- 캡처: Chapter05 Step2·4와 Chapter06 Step2·3 screenshot 확보, Chapter06 Step1 console 예제 제외
...
| Import status | code import 완료 / Chapter05 Step1–4와 Chapter06 Step1–3 순차 verification 완료 |
| Public readiness | 검토 필요 |
| Build/run status | Chapter05 Step1–4와 Chapter06 Step1–3 Debug/Release x64 현재 확인, 나머지 과거 확인 |
| Next action | Chapter06 Step4 Shaders 순차 정규화 |
