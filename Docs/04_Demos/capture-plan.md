...
- demo 설명과 우선순위: `Docs/04_Demos/*/demo-index.md`, `Docs/04_Demos/demo-priority.md`
...
`Docs/03_Verification/capture-matrix.md`에는 capture 결과의 상태만 기록한다. 상세 설명은 `Docs/04_Demos`와 Example/Topic 문서에 둔다.
