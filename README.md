...
`Part1_Chapter01-02` pilot, `Part1_Chapter03`과 `Part2_Chapter04` 순차 정규화를 마감했다. `Part2_Chapter05-08`은 Chapter05 Step1·2를 정규화했고 다음 대상은 Step3 DirectXMath다.
...
- [Chapter05 Step2 Lights(GLM)](Part2_Chapter05-08/05_AffineTransformations_Step2_Lights%28GLM%29/README.md): GLM model·normal transform과 CPU Blinn-Phong lighting
...
| `Part2_Chapter05-08` | DirectX11 pipeline, texture, mesh 흐름 | 완료 | Chapter05 Step1·2 문서화·재검증 완료 |
