...
- Build/run: Step1 Matrix(GLM), Step2 Lights(GLM) 성공 / Step3 DirectXMath 빌드 성공, 실행 미확인
- 캡처: 보류
...
| Next action | `05_AffineTransformations_Step3_DirectXMath` Debug/Release 실행 확인 |
...
| `05_AffineTransformations_Step3_DirectXMath` | archive 반영 완료, Debug/Release 빌드 확인 완료, 실행 미확인 |
