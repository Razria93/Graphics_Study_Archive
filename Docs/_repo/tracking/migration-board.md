...
| Part2 Ch05-08 | `06_GraphicsPipeline_Step4_Shaders` | 완료 | 빌드 성공 / 실행 미확인 | 진행 중 | 완료 | 보류 | Shader semantics and pixel shader constant buffer |
| Part2 Ch05-08 | `05_*` - `08_*` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | Step5 이후 후보 |
