...
| Part3 Ch09 | `09_UserInteraction_Step4_QuaternianRotation` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | raw spelling 유지, quaternion rotation, 사용자 Debug/Release 확인 대기 |
| Part3 Ch09 | `09_UserInteraction_Step5_VirtualTrackball`-`Step6_MouseDragMove` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | Step4 확인 후 순차 import |
