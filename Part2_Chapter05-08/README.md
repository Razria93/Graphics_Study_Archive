...
- Build/run: Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath 성공 / Step4 Lights(SimpleMath) 빌드 성공, 실행 미확인
- 캡처: 보류
...
| Build/run status | Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath 성공 / Step4 Lights(SimpleMath) 빌드 성공, 실행 미확인 |
| Next action | `05_AffineTransformations_Step4_Lights(SimpleMath)` Debug/Release 실행 확인 |
...
| `05_AffineTransformations_Step4_Lights(SimpleMath)` | archive 반영 완료, Debug/Release 빌드 확인 완료, 실행 미확인 |
