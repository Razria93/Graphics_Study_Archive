...
이 문서는 `Portfolio_RayTracer`의 demo capture/result 후보와 capture/result 연결 상태를 기록한다.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 최소 capture | 없음 | `Portfolio_RayTracer/README.md` | 미확인 | `Docs/02_Verification` | 없음 | 미게시 | 후보 | build/run 확인 후 갱신 |
