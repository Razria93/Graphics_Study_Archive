...
| `WU-GraphicsLab-Architecture` | 기본 제외 | 기본 제외 | PR #41 (merged), PR #42 (Draft closeout) | [WU-GraphicsLab-Architecture](work-units/WU-GraphicsLab-Architecture.md) | Phase S, Phase A와 WU-A0 architecture 작업 PR을 merge했고 closeout Draft 사용자 검수를 마쳤다. |
