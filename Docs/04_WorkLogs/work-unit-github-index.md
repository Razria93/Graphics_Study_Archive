...
| `WU-Part1 / Chapter03` | `Docs/07_GitHub/plan/comments/phase-2-4-plan-comment.md` (`comment-ready`) | 제외 | 없음 | `Docs/07_GitHub/issues/demo/demo_part1_chapter03.md` (`ready`) | 없음 | `Docs/07_GitHub/prs/part1_chapter03.md` (`ready`) | [WU-Part1](work-units/WU-Part1.md) | Phase 2-4 Chapter03 게시 후보이며 원격 객체는 아직 생성하지 않았다. |
