...
| --- | --- | --- | --- | --- |
| [WU-Part1](work-units/WU-Part1.md) | `Part1_Chapter01-02`, `Part1_Chapter03`, `Portfolio_GraphicsLab/Rendering/RayTracing` 기초 연결 | Example, RayTracing Topic, Verification, Demo | 진행 중 | `02_Bloom`과 Chapter03 마감. GraphicsLab scaffold 완료, WU-A0 architecture 검수 후 reconstruction 진행 |
| [WU-GraphicsLab-Architecture](work-units/WU-GraphicsLab-Architecture.md) | Phase S reconstruction 전략, Phase A original evidence, WU-A0 architecture | Decision, Review, Architecture, Part1 roadmap | 검증 중 | 책임 구조 상세화와 validator 통과, architecture branch 원격 게시 승인 전 |
