...
| Part1 | `Part1_Chapter03/03_Raytracing_Step14_CubeEnvironment` | 성공 | 성공 | 미확인 | 보류 | buildable scaffold, environment asset 미포함 |
...
| `Part1_Chapter03/03_Raytracing_Step14_CubeEnvironment` | `C:\ComputerGraphics\Part1_Chapter03\03_Raytracing_Step14_CubeEnvironment` | cube environment scaffold, raw environment assets 미포함 |
