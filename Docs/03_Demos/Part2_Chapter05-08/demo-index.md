...
- 순차 진행: Chapter05 Step1 Matrix(GLM) → Step2 Lights(GLM) → Step3 DirectXMath
- 주요 demo 후보: pipeline, modeling, cubemap, IBL, bloom
- 비고: Step1·3은 설명 중심 상세 Demo, Step2는 Chapter 최초 graphics Demo와 최소 visual로 유지
...
| video | 없음 | Step1·2·3 | [Matrix](../../01_Topics/Rasterization/MatrixAndAffineTransformations.md) | [Verification](../../02_Verification/Part2_Chapter05-08/verification-index.md) | 없음 | 미게시 | 미확인 | Step1·3 console과 Step2 정적 비교는 제외하며 후속 예제는 별도 판정 |
