...
| `11_TexturingTechniques_Step4_HDRI` | primary | 반영 완료 | 미확인 | 검토 필요 | EXR/HDRI texture loading, `OutdoorHDRI024_4K-HDR.exr` raw에서 미발견 |
...
사용자가 `11_TexturingTechniques_Step4_HDRI` Debug/Release 실행을 확인하면 status/tracking 문서를 갱신합니다.
