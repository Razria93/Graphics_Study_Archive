...
| `10_GeometryPipeline_Step5_Tessellation` | 반영 완료 | 미확인 | 검토 필요 | hull/domain shader, Release shader setting 보정 |
...
1. 사용자가 `10_GeometryPipeline_Step5_Tessellation` Debug/Release 실행을 확인합니다.
2. 실행 확인 후 status 문서와 tracking board를 갱신합니다.
3. 다음 import 대상은 `11_TexturingTechniques_Step1_Mipmaps`입니다.
