...
| `10_GeometryPipeline_Step4_Fireball` | 반영 완료 | 미확인 | 검토 필요 | geometry/fireball shader, fireball texture 포함, Release shader setting 보정 |
...
1. 사용자가 `10_GeometryPipeline_Step4_Fireball` Debug/Release 실행을 확인합니다.
2. 실행 확인 뒤 status 문서와 tracking board를 갱신합니다.
3. 다음 import 대상은 `10_GeometryPipeline_Step5_Tessellation`입니다.
