...
| Build/run status | `08_ShaderToys_Step2_Cubemapping`까지 실행 확인 완료 |
| Next action | `08_ShaderToys_Step3_EnvironmentMapping` Debug/Release 실행 확인 |
