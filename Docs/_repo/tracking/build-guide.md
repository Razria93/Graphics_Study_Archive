...
| Part2 | `Part2_Chapter05-08/06_GraphicsPipeline_Step5_Texturing_LightingSelf` | 성공 | 성공 | 미확인 | 보류 | texture sampling with lighting, `pwsh.exe` 미탐지 후 Windows PowerShell fallback, asset public readiness 검토 필요 |
