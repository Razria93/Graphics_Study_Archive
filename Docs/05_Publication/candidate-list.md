...
| Demo capture/result | `Docs/03_Demos`, `Docs/_assets` | 직접 실행 결과 capture/result로 사용 가능 | 검토 필요 | `02_Bloom` result image는 `Docs/_assets/captures/part1_chapter01-02_02_bloom_result.png`로 승격함. public 공개 확정은 아님 |
