...
| `WU-Part4 / Chapter14` | `comment-ready`; `Docs/07_GitHub/plan/comments/phase-5-1-plan-comment.md` | 기본 제외 | 없음 | `Docs/07_GitHub/issues/demo/demo_part4_chapter14.md` (`ready`) | 없음 | `Docs/07_GitHub/prs/part4_chapter14.md` (`ready`) | [WU-Part4](work-units/WU-Part4.md) | Demo Issue, 누적 Progress comment와 Phase 5-1 완료 댓글은 게시 후보 상태다. remote 게시는 승인 후 수행한다. |
