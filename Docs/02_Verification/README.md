...
| Portfolio GraphicsLab | [Portfolio_GraphicsLab](Portfolio_GraphicsLab/verification-index.md) | WU-R0 x64 build/run 현재 확인 |
...
- `Portfolio_GraphicsLab`과 Part1부터 Part4까지의 대표 검증 결과를 한 문서에서 비교할 필요가 있다.
