...
| Part3_Chapter09 | Step1 FirstPersonView | Step5 VirtualTrackball | Step6 MouseDragMove, Step2 MousePicking | 확보 | Step1은 interaction 기준선, Step5는 대표, Step6은 보조 후보로 둔다. Step1~6 screenshot, storyboard 7장과 selected local video 8개를 확보했으며 Publication은 권리 근거 확인 전 `검토 필요`로 유지한다. |
