...
- Build/run: Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath, Step4 Lights(SimpleMath), Pipeline Step1 COM, Pipeline Step2 InitializingD3D, Pipeline Step3 ModelViewProj, Pipeline Step4 Shaders, Pipeline Step5 Texturing, Pipeline Step6 Lighting 성공
- 캡처: 보류
...
| Next action | `06_GraphicsPipeline_Step9_PhongVsBlinnPhong` 사용자 실행 확인 |
...
| `06_GraphicsPipeline_Step9_PhongVsBlinnPhong` | archive 반영 완료, Debug/Release build 성공, 실행 미확인 |
