...
| `WU-Part2 / Chapter05-08` | `Docs/07_GitHub/plan/comments/phase-3-2-plan-comment.md` (`comment-ready`) | 기본 제외 | 없음 | Chapter05·06·07 후보 3개 (`ready`) | 없음 | `Docs/07_GitHub/prs/part2_chapter05-08.md` (`ready`) | [WU-Part2](work-units/WU-Part2.md) | Chapter08은 외부 asset 권리 근거 확인 전 Demo Issue 후보에서 제외한다. |
