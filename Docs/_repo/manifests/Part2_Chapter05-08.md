...
- Build/run status: Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath 성공
...
1. 다음 후보 `05_AffineTransformations_Step4_Lights(SimpleMath)`의 raw 구조를 확인합니다.
2. DirectXTK SimpleMath 기반 lighting 예제와 Step2 GLM 버전의 차이를 확인합니다.
