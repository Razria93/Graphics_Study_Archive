...
| 누적 진행 댓글 | posted | [댓글 5091068690](https://github.com/Razria93/Graphics_Study_Archive/issues/7#issuecomment-5091068690) | `Docs/07_GitHub/plan/plan-progress.md` | Remote는 Phase 5-2 게시 상태다. |
...
| `WU-Part4 / Chapter15` | [댓글 5200004532](https://github.com/Razria93/Graphics_Study_Archive/issues/7#issuecomment-5200004532) (`posted`; `Docs/07_GitHub/plan/comments/phase-5-2-plan-comment.md`) | 기본 제외 | [Demo Issue #31](https://github.com/Razria93/Graphics_Study_Archive/issues/31) (`posted`) | `Docs/07_GitHub/issues/demo/demo_part4_chapter15.md` (`ready`) | [PR #32](https://github.com/Razria93/Graphics_Study_Archive/pull/32) (`Merged`; [`1deda11`](https://github.com/Razria93/Graphics_Study_Archive/commit/1deda11ac9acb0b2cad3ef67a00ca200744b2d05)) | `Docs/07_GitHub/prs/part4_chapter15.md` (`ready`) | [WU-Part4](work-units/WU-Part4.md) | Ex1501, Ex1502와 10초 지연 Ex1503 tracked capture를 Chapter15 Demo Issue #31에 게시하고 PR #32를 일반 merge commit 방식으로 마감했다. Ex1502는 원본 `flare0.dds`를 직접 링크하지 않고 rendered evidence로만 다룬다. |
