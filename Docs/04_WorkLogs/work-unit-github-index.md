...
| `WU-Part2 / Chapter04` | `comment-ready` (`Docs/07_GitHub/plan/comments/phase-3-1-plan-comment.md`) | 기본 제외 | 없음 | `Docs/07_GitHub/issues/demo/demo_part2_chapter04.md` (`ready`) | 없음 | `Docs/07_GitHub/prs/part2_chapter04.md` (`ready`) | [WU-Part2](work-units/WU-Part2.md) | Chapter04 Demo Issue, PR과 Phase 3-1 완료 댓글 게시 후보 준비 완료 |
