...
- Step4 DrawingSphere와 Step5 PhongShading의 기본·파라미터 조정 screenshot, Step6 PerspectiveView의 기본 screenshot을 동일한 전체 application window 규격으로 확보했다.
- Step7~14는 build/run과 문서화를 같은 순서로 완료한 뒤 capture 필요성을 판단한다.
