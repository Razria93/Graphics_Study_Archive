...
| Part2 Ch05-08 | `06_GraphicsPipeline_Step5_Texturing_LightingSelf` | 완료 | 성공 | 진행 중 | 미확인 | 보류 | texture sampling with lighting, raw project filename은 `06_GraphicsPipeline_Step5_Texturing.*` 재사용, asset public readiness 검토 필요 |
| Part2 Ch05-08 | `05_*` - `08_*` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | Step5 Texturing_LightingSelf 이후 후보 |
