...
- 현재 문서화: Step4 완료, Step5 문서화 대기
- 현재 재검증: Step4 Debug/Release x64 build/run 완료
- 과거 확인: Step5~14 Debug/Release build/run 성공, 현재 재검증 필요
- Capture: Step4 screenshot 확보
...
| Public readiness | Step4 검토 필요, Step5~14 미판정 |
| Build/run status | Step4 현재 확인, Step5~14 과거 확인 |
...
| Topic | [Ray Tracing Topics](../Docs/01_Topics/RayTracing/README.md) |
| Next action | Step5 PhongShading 검증과 문서화 |
...
| Step5 | `03_Raytracing_Step5_PhongShading` | 대기 | 과거 확인 | 대기 |
| Step6 | `03_Raytracing_Step6_PerspectiveView` | 대기 | 과거 확인 | 대기 |
...
Step5 이후 Topic은 해당 Step의 코드와 실행 결과를 확인한 뒤 순서대로 연결한다.
