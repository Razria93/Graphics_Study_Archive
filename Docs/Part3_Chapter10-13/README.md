...
- Build/run: Step1-Step5 성공, 11-Step1 재확인 필요
- Capture: 보류
...
| `11_TexturingTechniques_Step1_Mipmaps` | 반영 완료 | 미확인 | 검토 필요 | OriginalExamples 의도 기준 `Mipmaps Level` GUI 복구, `captured.png` 제외, Release shader setting 보정 |
...
1. 사용자가 `11_TexturingTechniques_Step1_Mipmaps` Debug/Release 실행을 다시 확인합니다.
