...
시연 video에서 선택한 1.010s, 2.530s, 4.050s frame을 순서대로 배치한다. 상단 `01`부터 `03`까지와 timestamp는 frame 순서와 local-only 원본 video 위치를 기록한다.
...
| 출력 | 1.010s, 2.530s, 4.050s timestamp frame으로 구성한 skeletal pose storyboard |
