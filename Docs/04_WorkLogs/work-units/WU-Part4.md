...
| GitHub | Chapter14 merged · Chapter15 Draft PR 생성 | Chapter14 Demo Issue #29, Progress Phase 5-1 완료 댓글과 PR #30을 게시·review 대응·merge까지 마감했다. Chapter15 Demo Issue #31, Progress 누적 댓글 갱신, Phase 5-2 완료 댓글과 Draft PR #32를 게시했다. |
...
1. Chapter15 Draft PR #32의 Actions 완료와 Ready for Review 전환 여부를 별도 승인으로 확인한다.
