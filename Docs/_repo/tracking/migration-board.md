...
| Part3 Ch10-13 | `10_GeometryPipeline_Step4_Fireball` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | primary raw 기준 반영, fireball texture 포함, Release shader setting 보정 |
| Part3 Ch10-13 | `10_GeometryPipeline_Step5_Tessellation`-`13_*` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | primary raw 기준 진행, `_2`는 reference-only 비교용 |
