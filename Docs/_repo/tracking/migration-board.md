...
| Part3 Ch10-13 | `10_GeometryPipeline_Step1_GeometryShader` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | primary raw 기준 반영, `_Solution`은 reference-only 후보 |
| Part3 Ch10-13 | `10_GeometryPipeline_Step2_Billboards`-`13_*` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | primary raw 기준 진행, `_2`는 reference-only 비교용 |
