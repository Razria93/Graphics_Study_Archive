...
| Particle baseline | [Ex1501 ParticleSystem](15_01_ParticleSystem.md) | `Ex1501_ParticleSystem` | GPU Simulation | [Verification](../../02_Verification/Part4_Chapter14-20/verification-index.md) | [tracked capture](../../_assets/captures/part4_chapter15_01_particle_system.png) | [Issue #31](https://github.com/Razria93/Graphics_Study_Archive/issues/31) | 후보 | Chapter15 Debug x64 smoke에서 particle stream 후보를 승격. Chapter15 대표 set에 포함 |
| Sprite fire particles | [Ex1502 SpriteFireEffect](15_02_SpriteFireEffect.md) | `Ex1502_SpriteFireEffect` | GPU Simulation, Texturing | [Verification](../../02_Verification/Part4_Chapter14-20/verification-index.md) | [tracked capture](../../_assets/captures/part4_chapter15_02_sprite_fire_effect.png) | [Issue #31](https://github.com/Razria93/Graphics_Study_Archive/issues/31) | 후보 | 원본 `flare0.dds`를 직접 링크하지 않고 rendered evidence로만 다룬다. 필요 시 대체 texture로 교체하거나 비공개 전환 |
| SPH water particles | [Ex1503 SphWater](15_03_SphWater.md) | `Ex1503_SphWater` | GPU Simulation | [Verification](../../02_Verification/Part4_Chapter14-20/verification-index.md) | [tracked capture](../../_assets/captures/part4_chapter15_03_sph_water.png) | [Issue #31](https://github.com/Razria93/Graphics_Study_Archive/issues/31) | 후보 | 10초 지연 capture에서 SPH particles가 아래에 쌓인 selected 후보를 승격. simulation movement는 desktop video 후속 후보 |
...
- Chapter15 `Ex1501`, `Ex1502`와 10초 지연 `Ex1503` selected screenshot은 `Docs/_assets/captures`에 승격하고 상세 Demo와 [Issue #31](https://github.com/Razria93/Graphics_Study_Archive/issues/31)에 연결했다. `Ex1502`는 원본 `flare0.dds`를 직접 링크하지 않고 rendered evidence로만 다룬다.
