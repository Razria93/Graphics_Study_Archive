...
- Build/run: Step1-Step5, 11-Step1-Step5, 12-Step1-Step2, 13-Step1, 13-Step2 PipelineStateObject, 13-Step2 Shadow, and 13-Step3 성공
- Capture: 보류
...
| `13_LightAndShadow_Step4_ShadowMapping` | 반영 완료 | 미확인 | 검토 필요 | shadow mapping, primary raw shadow lookup 구현본 반영, Release shader setting 보정 |
...
1. `13_LightAndShadow_Step4_ShadowMapping` Debug/Release 실행 확인.
