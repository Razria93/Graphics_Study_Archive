...
| Part2_Chapter04 | 확보 | 확보 | 확보 | Step1 Triangle, Step1A 3·32, Step2 Circle, Step3 기본·조정, Step4 Animation2D, Step5 DepthBuffer 기본·반전, Step6 ShadersConcept, Step7 Culling On/Off, Step8 projection 3단계와 Step9 Shading 전체 창 screenshot 확보. Step8·Step9는 정지 이미지로 결과를 설명하므로 video를 제외한다. 대표 Demo는 Step10 확인 후 확정한다 |
