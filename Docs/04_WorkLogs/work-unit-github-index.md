...
| `WU-Part3` | Chapter09 로컬 정규화 완료 | 기본 제외 | 없음 | `Docs/07_GitHub/issues/demo/demo_part3_chapter09.md` (`ready`) | 없음 | 예정 | [WU-Part3](work-units/WU-Part3.md) | 원본 runtime asset은 비공개로 유지하고 Step5·1·6 rendered evidence를 Demo Issue 후보로 선정한다. |
