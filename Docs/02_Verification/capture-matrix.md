...
| Part1_Chapter03 | 확보 | 미확인 | 미확인 | Step4 DrawingSphere부터 Step10 Texturing까지 전체 창 screenshot 확보. Step10은 사용자 직접 생성 석재 texture로 자연석 mapping·보간·seam 부재를 확인함. 대표 등급은 전체 Step 완료 후 확정 |
