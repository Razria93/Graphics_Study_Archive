...
bool ExampleApp::Initialize() {
    ...
    */
    ...
    // Ground
    {
        MeshData ground = GeometryGenerator::MakeSquare(0.4f);
        // MeshData ground = GeometryGenerator::MakeSquareGrid(2048,
        // 2048, 20.0f, {40.0f, 40.0f});
        ...
        */
        ...
        m_meshGroupGround.UpdateModelWorld(
            Matrix::CreateScale(2.0f, 1.0f, 1.0) *
        ...
        m_meshGroupGround.m_basicVertexConstantData.heightScale = 0.02f;
...
void ExampleApp::Render() {
    ...
    // init floatRTV
    // float 범위의 RTV를 렌더타켓으로 설정하여 렌더링 할 것임을 설정함
    ...
    // Texture2DMS는 하나의 픽셀에 여러개의 샘플링 포인트에서 샘플링한 색상들을 저장하기 위해 형태가 좀 다름
