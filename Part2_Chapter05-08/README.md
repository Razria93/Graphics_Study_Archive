...
- Build/run: Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath, Step4 Lights(SimpleMath), Pipeline Step1 COM, Pipeline Step2 InitializingD3D, Pipeline Step3 ModelViewProj, Pipeline Step4 Shaders 성공 / Pipeline Step5 Texturing 빌드 성공, 실행 미확인
- 캡처: 보류
...
| Build/run status | Step1 Matrix(GLM), Step2 Lights(GLM), Step3 DirectXMath, Step4 Lights(SimpleMath), Pipeline Step1 COM, Pipeline Step2 InitializingD3D, Pipeline Step3 ModelViewProj, Pipeline Step4 Shaders 성공 / Pipeline Step5 Texturing 빌드 성공, 실행 미확인 |
| Next action | `06_GraphicsPipeline_Step5_Texturing` Debug/Release 실행 확인 |
...
| `06_GraphicsPipeline_Step5_Texturing` | archive 반영 완료, Debug/Release build 성공, 실행 미확인 |
