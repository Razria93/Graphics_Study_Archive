...
2. [Audit Guide](../../Docs/98_Tools/document-system-audit-guide.md)의 시작 절차를 수행한다.
...
[Document System Audit Report](../../Docs/98_Tools/templates/document-system-audit-report.md)의 구조와 발견 항목 필드를 사용한다. 초기·최종 validator, 변경 여부, commit readiness를 포함한다.
