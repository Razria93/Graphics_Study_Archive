...
| `Ex1602_CurlNoise`           | `1602`           | `Part4_Chapter14-20/Examples.sln` | 성공          | 성공        | 성공            | 성공          | tracked 후보 | 2026-08-07 Debug와 Release x64 build/run/capture smoke 성공. 0.765s, 1.500s, 3.000s colored curl-noise density trail storyboard를 `Docs/_assets/captures`에 승격함 |
