...
| `10_GeometryPipeline_Step2_Billboards` | primary | 반영 완료 | 미확인 | 검토 필요 | billboard, TreeBillboards selected assets 포함 |
...
사용자가 `10_GeometryPipeline_Step2_Billboards` Debug/Release 실행을 확인한 뒤 status/tracking 문서를 갱신합니다.
