...
- Chapter15 `Ex1501`, `Ex1502`와 10초 지연 `Ex1503` selected screenshot은 `Docs/_assets/captures`에 승격하고 상세 Demo와 local Demo Issue 후보에 연결했다. `Ex1502`는 원본 `flare0.dds`를 직접 링크하지 않고 rendered evidence로만 다룬다.
