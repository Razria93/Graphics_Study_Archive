...
| Part3 Ch10-13 | `13_LightAndShadow_Step8_UnrealSphereLight` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | sphere light, primary raw `BasicPS.hlsl` representative point 구현본 반영, Release shader setting 보정, 사용자 Debug/Release 실행 확인 필요 |
