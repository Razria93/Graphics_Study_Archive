...
| Part4 Ch14-20 | `Examples` project scaffold | 진행 중 | 성공 | 진행 중 | 미확인 | 보류 | 단일 project 구조 반영, `.clang-format` project reference 제거, Ex1401-Ex1502 Debug/Release 확인, Ex1503 확인 대기 |
...
| Part4 Ch15 | `Ex1503_SphWater` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | CPU SPH water simulation, density/pressure interaction, command argument `1503` |
