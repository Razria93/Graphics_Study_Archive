# Status: 03_Raytracing_Step12_Reflection

| Item | Status | Note |
| --- | --- | --- |
| Raw reference | 확인 | `C:\ComputerGraphics\Part1_Chapter03\03_Raytracing_Step12_Reflection` |
| Related raw note | 확인 | `Docs_Graphics/_99_Study/_01_Graphics/Chapter03_Raytracing_Step12_Reflection.md` |
...
```powershell
& 'C:\Program Files\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\MSBuild.exe' .\Part1_Chapter03\03_Raytracing_Step12_Reflection\03_Raytracing_Step12_Reflection.sln /p:Configuration=Debug /p:Platform=x64 /m
& 'C:\Program Files\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\MSBuild.exe' .\Part1_Chapter03\03_Raytracing_Step12_Reflection\03_Raytracing_Step12_Reflection.sln /p:Configuration=Release /p:Platform=x64 /m
```

## Verification notes

- Step12는 local Phong shading과 reflected ray color를 material weight로 섞는 예제입니다.
