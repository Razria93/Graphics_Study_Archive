...
| Part2 | `Part2_Chapter05-08/06_GraphicsPipeline_Step9_PhongVsBlinnPhong` | 성공 | 성공 | 성공 | 보류 | 사용자 Debug/Release 실행 확인, Phong vs Blinn-Phong specular, Release HLSL shader type 설정 보강 |
...
| `Part2_Chapter05-08/06_GraphicsPipeline_Step3_ModelViewProj` | `C:\ComputerGraphics\Part2_Chapter05-08\06_GraphicsPipeline_Step3_ModelViewProj` | Model/View/Projection matrix and constant buffer |
...
| `Part2_Chapter05-08/06_GraphicsPipeline_Step7_ResizingViewport` | `C:\ComputerGraphics\Part2_Chapter05-08\06_GraphicsPipeline_Step7_ResizingViewport` | Viewport resizing, ImGui control panel 영역 제외, `D3D11_VIEWPORT`, `RSSetViewports()` |
| `Part2_Chapter05-08/06_GraphicsPipeline_Step8_ResizingWindow` | `C:\ComputerGraphics\Part2_Chapter05-08\06_GraphicsPipeline_Step8_ResizingWindow` | Window resize, swap chain `ResizeBuffers()`, render target/depth stencil 재생성 |
| `Part2_Chapter05-08/06_GraphicsPipeline_Step9_PhongVsBlinnPhong` | `C:\ComputerGraphics\Part2_Chapter05-08\06_GraphicsPipeline_Step9_PhongVsBlinnPhong` | Phong vs Blinn-Phong specular, `useBlinnPhong`, half vector/reflection vector |
