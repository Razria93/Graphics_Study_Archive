...
- Build/run: Step1-Step5, 11-Step1-Step5, 12-Step1-Step2, 13-Step1, 13-Step2 PipelineStateObject, 13-Step2 Shadow, 13-Step3, 13-Step4, 13-Step5, and 13-Step6 성공; 13-Step7 미확인
- Capture: 보류
...
| `13_LightAndShadow_Step7_Halo` | 반영 완료 | 미확인 | 검토 필요 | halo post effect, primary raw `PostEffectsPS.hlsl` 구현본 반영, Release shader setting 보정 |
...
1. `13_LightAndShadow_Step7_Halo` Debug/Release 실행 확인이 필요합니다.
