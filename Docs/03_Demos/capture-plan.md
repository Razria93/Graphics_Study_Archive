...
- Step4 DrawingSphere와 Step5 PhongShading의 기본·파라미터 조정 screenshot, Step6 PerspectiveView, Step7 Triangle, Step8 Shadow의 기본 screenshot을 동일한 전체 application window 규격으로 확보했다.
