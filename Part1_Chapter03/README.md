...
- Capture: Step4~10 screenshot 확보
...
| Public readiness | Step4~10 검토 필요, Step11~14 미판정 |
| Build/run status | Step4~10 현재 확인, Step11~14 과거 확인 |
| Texture/environment asset | Step10 사용자 직접 생성 석재 texture 적용, Step11 이후 asset은 각 Step 작업에서 별도 검토 |
...
| Next action | Step11 Supersampling 검증과 문서화 |
...
- Step11~13 texture는 실제 사용 여부와 출처를 각 Step 작업에서 확인한다.
