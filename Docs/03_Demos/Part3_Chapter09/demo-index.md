...
이 문서는 `Part3_Chapter09`의 demo capture/result 후보와 capture/result 연결 상태를 기록한다.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 최소 capture | 없음 | `09_CameraAndMouseControl` | 미확인 | `Docs/02_Verification` | 없음 | 미게시 | 후보 | build/run 확인 후 갱신 |
