...
| Part3 Ch10-13 | `13_LightAndShadow_Step7_Halo` | 완료 | 미확인 | 진행 중 | 미확인 | 아니오 | halo post effect, primary raw `PostEffectsPS.hlsl` 구현본 반영, Release shader setting 보정, 사용자 Debug/Release 실행 확인 필요 |
| Part3 Ch10-13 | `13_LightAndShadow_Step8_UnrealSphereLight` | 예정 | 미확인 | 미확인 | 미확인 | 아니오 | primary raw 기준 진행, `_2`는 reference-only 비교용, character 사용 여지가 있으면 character 우선 |
