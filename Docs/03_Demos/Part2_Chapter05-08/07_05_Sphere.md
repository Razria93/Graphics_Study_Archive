...
- 두 반구의 합성, pole 처리, UV와 index 구성을 설명한다.
...
![Chapter07 Step5 Sphere](../../_assets/captures/part2_chapter07_05_sphere.png)
...
- [위쪽 반구 vertex와 UV 생성](../../../Part2_Chapter05-08/07_Modeling_Step5_Sphere/GeometryGenerator.cpp#L279-L339)
- [아래쪽 반구 vertex와 wrap UV 생성](../../../Part2_Chapter05-08/07_Modeling_Step5_Sphere/GeometryGenerator.cpp#L377-L436)
...
- [위쪽 반구 body와 pole triangle](../../../Part2_Chapter05-08/07_Modeling_Step5_Sphere/GeometryGenerator.cpp#L342-L371)
- [아래쪽 반구 offset과 triangle](../../../Part2_Chapter05-08/07_Modeling_Step5_Sphere/GeometryGenerator.cpp#L439-L468)
- [Sphere 파라미터와 GPU buffer 연결](../../../Part2_Chapter05-08/07_Modeling_Step5_Sphere/ExampleApp.cpp#L42-L52)

## 시각 결과

Wireframe은 equator를 중심으로 위·아래 latitude ring이 이어지고, longitude 방향의 slice가 pole로 수렴하는 구조를 보여준다. Pole band는 triangle 한 개씩으로 닫혀 면적 0 triangle을 만들지 않는다.

## 구현 범위와 한계

- Sphere는 242 vertices와 380 triangles를 사용한다.
...
- [Sphere 호출과 GPU buffer 생성](../../../Part2_Chapter05-08/07_Modeling_Step5_Sphere/ExampleApp.cpp#L42-L52)
- [위쪽 반구 생성](../../../Part2_Chapter05-08/07_Modeling_Step5_Sphere/GeometryGenerator.cpp#L279-L371)
- [아래쪽 반구 생성](../../../Part2_Chapter05-08/07_Modeling_Step5_Sphere/GeometryGenerator.cpp#L377-L468)
- [Surface와 optional normal draw](../../../Part2_Chapter05-08/07_Modeling_Step5_Sphere/ExampleApp.cpp#L225-L281)
- [Resize resource lifetime](../../../Part2_Chapter05-08/07_Modeling_Step5_Sphere/AppBase.cpp#L485-L529)
