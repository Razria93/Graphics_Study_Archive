...
이 PR은 `Part2_Chapter05-08`의 30개 예제를 Chapter05 affine transformation API 비교, Chapter06 DirectX11 pipeline, Chapter07 procedural modeling과 Chapter08 shader experiment 흐름으로 재검증하고 설명 가능한 문서 구조로 정리한다. Example README, Topic, Verification과 상세 Demo를 연결하고 공개 안전성을 확인한 Chapter05·06·07 결과를 대표 Demo로 구성한다.
...
- 제외 범위: Graphics executable CI와 권리 근거가 확인되지 않은 외부 asset의 대표 publication visual 선정
...
- Shader experiments: Cubemap, environment lighting, Fresnel과 post-processing 구현·실행 결과를 검증하고 권리 근거가 확인된 결과만 공개 대표 visual로 선별한다.
...
- README: [Part2 Chapter05-08 README](https://github.com/Razria93/Graphics_Study_Archive/blob/main/Part2_Chapter05-08/README.md)
...
- Verification: [Chapter05-08 Verification](https://github.com/Razria93/Graphics_Study_Archive/blob/main/Docs/02_Verification/Part2_Chapter05-08/verification-index.md)
...
- Chapter README: [Part2 Chapter05-08](https://github.com/Razria93/Graphics_Study_Archive/blob/main/Part2_Chapter05-08/README.md)
- Topic: [DirectX11 Pipeline](https://github.com/Razria93/Graphics_Study_Archive/blob/main/Docs/01_Topics/DirectX11Pipeline/README.md) · [Modeling And Geometry](https://github.com/Razria93/Graphics_Study_Archive/blob/docs/part2-chapter05-08-workflow/Docs/01_Topics/ModelingAndGeometry/README.md)
- Verification: [Part2 Chapter05-08 Verification](https://github.com/Razria93/Graphics_Study_Archive/blob/main/Docs/02_Verification/Part2_Chapter05-08/verification-index.md)
- Demo: [Part2 Chapter05-08 Demo Index](https://github.com/Razria93/Graphics_Study_Archive/blob/main/Docs/03_Demos/Part2_Chapter05-08/demo-index.md)
