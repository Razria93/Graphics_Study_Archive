...
| Part2_Chapter05-08 | 확보 | 후보 | 확보 | Chapter05 Step1·3과 Chapter06 Step1 console 예제는 capture를 제외한다. Chapter05 Step2·4와 Chapter06 Step2–9 screenshot을 확보했다. Chapter06 Step3 selected local video를 확인했다. Chapter07 Step1–7은 wireframe, vertex normal, procedural Grid, 열린 Cylinder, Sphere, subdivision과 face normal 전체 창 screenshot을 확보하고 정적 결과로 충분해 video를 제외했다. Step5 ReferenceSolution은 private 비교 근거로만 유지한다 |
