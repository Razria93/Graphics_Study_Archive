...
- Debug/Release x64 Clean/Rebuild와 run: Step1부터 Step6까지 성공, 2026-08-03 현재 확인
- Capture: Step1부터 Step6까지 기본 PNG, Step2 hover·Step3 press PNG와 Step1·3·4·5·6 selected local video 확보
- Runtime working directory: 각 project 폴더
- Publication: 원본 runtime asset은 비공개로 유지하고 Step1부터 Step6까지의 직접 실행 visual은 승인된 Bundle 예외에 따라 공개 가능
