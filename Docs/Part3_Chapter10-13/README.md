...
- Build/run: Step1-Step5, 11-Step1-Step5, 12-Step1-Step2, 13-Step1, 13-Step2 PipelineStateObject, and 13-Step2 Shadow 성공 / 13-Step3 미확인
- Capture: 보류
...
| `13_LightAndShadow_Step3_DepthBufferAndFog` | 반영 완료 | 미확인 | 검토 필요 | depth buffer/fog post effect, Release shader setting 보정 |
...
1. `13_LightAndShadow_Step3_DepthBufferAndFog` Debug/Release 실행 확인.
2. 다음 import 대상은 `13_LightAndShadow_Step4_ShadowMapping`입니다.
