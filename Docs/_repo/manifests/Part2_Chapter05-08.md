...
| `07_Modeling_Step9_ModelFiles` | 반영 완료 | 미확인 | 검토 필요 | Assimp model loading, Zelda FBX와 diffuse texture 선별 포함 |
...
1. `07_Modeling_Step9_ModelFiles` Debug/Release build/run을 사용자 환경에서 확인합니다.
2. 다음 후보는 `08_ShaderToys_*` 계열입니다.
