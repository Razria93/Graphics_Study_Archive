...
| `06_GraphicsPipeline_Step8_ResizingWindow` | 반영 완료 | build 성공 / run 미확인 | 검토 필요 | window resize, swap chain `ResizeBuffers()`, render target/depth stencil 재생성, texture asset public readiness 검토 필요 |
