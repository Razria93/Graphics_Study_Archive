...
| Chapter03 순차 작업 | 진행 중 | Step4 DrawingSphere부터 Step9 Barycentric Coordinates까지 build/run, README, Topic, Demo와 capture를 완료했다. |
...
1. `Part1_Chapter03` Step10 Texturing을 build/run하고 문서화한다.
2. Step11~14를 순서대로 검증하고 독립 상세 Demo를 축적한다.
